OpenMASS (Open Mass Analysis Software Suite) v2025r
...
Install by downloading this repo. You can run from source or the standalone .exe
Screen resolution should be 1920x1080 with 100% display scaling.

For more information, and to learn how to use the software, please find the user
guide 'OpenMASS User Guide.pdf' in this repo.
